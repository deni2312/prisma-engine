...
void Prisma::PipelineForward::create() {
    ...
    PipelineResourceDesc Resources[] =
    {
        ...
        {SHADER_TYPE_PIXEL, ShaderNames::STATIC_DIR_SHADOW.c_str(), 5, SHADER_RESOURCE_TYPE_TEXTURE_SRV,
         SHADER_RESOURCE_VARIABLE_TYPE_STATIC},
    ...
    m_pResourceSignature->GetStaticVariableByName(SHADER_TYPE_PIXEL, ShaderNames::STATIC_DIR_SHADOW.c_str())->Set(LightHandler::getInstance().dirShadowData());
...
void Prisma::PipelineForward::createAnimation()
{
    ...
    m_pResourceSignatureAnimation->GetStaticVariableByName(SHADER_TYPE_PIXEL, ShaderNames::STATIC_DIR_SHADOW.c_str())->Set(LightHandler::getInstance().dirShadowData());
