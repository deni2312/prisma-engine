...
void Prisma::CloudComponent::createUpSample()
{
    auto& contextData = PrismaFunc::getInstance().contextData();
    ...
    // Pipeline state name is used by the engine to report issues.
    // It is always a good idea to give objects descriptive names.
    PSOCreateInfo.PSODesc.Name = "UpSample Render";
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pVS;
    {
        ShaderCI.Desc.ShaderType = Diligent::SHADER_TYPE_VERTEX;
        ShaderCI.EntryPoint = "main";
        ShaderCI.Desc.Name = "UpSample VS";
        ShaderCI.FilePath = "../../../Engine/Shaders/UpsamplePipeline/vertex.glsl";
        contextData.device->CreateShader(ShaderCI, &pVS);
    }
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pPS;
    {
        ShaderCI.Desc.ShaderType = Diligent::SHADER_TYPE_PIXEL;
        ShaderCI.EntryPoint = "main";
        ShaderCI.Desc.Name = "UpSample PS";
        ShaderCI.FilePath = "../../../Engine/Shaders/UpsamplePipeline/fragment.glsl";
        contextData.device->CreateShader(ShaderCI, &pPS);
    }
