...
void Prisma::DrawDebugger::DrawVertices(JPH::RVec3Arg inV1, JPH::RVec3Arg inV2, JPH::RVec3Arg inV3, JPH::ColorArg inColor, ECastShadow inCastShadow)
{
    if (m_init) {
        ...
        m_vao.addAttribPointer(0, 3, sizeof(glm::vec3), (void*)0);
        ...
        case EDrawMode::Solid:
            {
                ...
                {
                    vertices.push_back(Prisma::JfromVec3(inModelMatrix * JPH::Vec3(triangle.mV[0].mPosition)));
                    vertices.push_back(Prisma::JfromVec3(inModelMatrix * JPH::Vec3(triangle.mV[1].mPosition)));
                    vertices.push_back(Prisma::JfromVec3(inModelMatrix * JPH::Vec3(triangle.mV[2].mPosition)));
