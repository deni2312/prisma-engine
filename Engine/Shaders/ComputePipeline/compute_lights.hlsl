...
{
    return bvec4(b2.x, b2.y, false, false);
}
bvec4 _ExpandVector(bvec3 b3)
{
    return bvec4(b3.x, b3.y, b3.z, false);
}
...
{
    outVec4 = vec4(inVec2, 0.0, 0.0);
}
void _ResizeVector(out vec3 outVec3, in vec2 inVec2)
{
    outVec3 = vec3(inVec2, 0.0);
}
...
{
    outVec4 = vec4(v, 0.0, 0.0, 0.0);
}
void _ResizeVector(out vec3 outVec3, in float v)
{
    outVec3 = vec3(v, 0.0, 0.0);
}
