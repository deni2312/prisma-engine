...
void Prisma::LightInfo::showSelectedDir(std::shared_ptr<Light<LightType::LightDir>> lightData,
...
void Prisma::LightInfo::showSelectedOmni(std::shared_ptr<Light<LightType::LightOmni>> lightData,
                                         const NodeViewer::NodeData& meshData) {
        auto type = lightData->type();
        float windowWidth = meshData.translate * meshData.width / 2.0f;
        auto nextRight = [&](float pos) {
...
void Prisma::LightInfo::showSelectedArea(std::shared_ptr<Light<LightType::LightArea>> lightData,
                                         const NodeViewer::NodeData& meshData) {
        auto type = lightData->type();
        float windowWidth = meshData.translate * meshData.width / 2.0f;
        auto nextRight = [&](float pos) {
