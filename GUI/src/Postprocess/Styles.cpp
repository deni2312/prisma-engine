...
void Prisma::GUI::PostprocessingStyles::createShaderBlit() {
    auto& contextData = PrismaFunc::getInstance().contextData();
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pVS;
    {
        ...
        ShaderCI.FilePath = "../../../GUI/Shaders/Blit/vertex.glsl";
        contextData.device->CreateShader(ShaderCI, &pVS);
    }
    ...
    Diligent::RefCntAutoPtr<Diligent::IShader> pPS;
    {
        ...
        ShaderCI.FilePath = "../../../GUI/Shaders/Blit/fragment.glsl";
        contextData.device->CreateShader(ShaderCI, &pPS);
    }
    ...
    m_psoBlit->GetStaticVariableByName(Diligent::SHADER_TYPE_PIXEL, "screenTexture")->Set(m_texture->GetDefaultView(Diligent::TEXTURE_VIEW_SHADER_RESOURCE));
...
void Prisma::GUI::PostprocessingStyles::renderBlit() {
    auto& contextData = PrismaFunc::getInstance().contextData();
