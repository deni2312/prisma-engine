...
Prisma::ImguiDebug::ImguiDebug() : m_lastFrameTime{glfwGetTime()}, m_fps{60.0f} {
        ...
        uiInput.keyboard = [&](int key, int action, int scancode) {
                ImGuiIO& io = ImGui::GetIO();
                io.AddKeyEvent(GUI::convertImGuiGlfwKey(key, scancode), (action == GLFW_PRESS));
...
void Prisma::ImguiDebug::drawGui() {
        ...
        if (ImGui::IsItemHovered()) {
                ...
                if (ImGui::BeginTable("StatsTable", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg)) {
                        ...
                        ImGui::Text("%.9f", m_timeCounterUI.duration_seconds());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Engine Time:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%.9f", m_timeCounterEngine.duration_seconds());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Meshes:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%zu", GlobalData::getInstance().currentGlobalScene()->meshes.size());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Animate Meshes:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%zu", GlobalData::getInstance().currentGlobalScene()->animateMeshes.size());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Omni Lights:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%zu", GlobalData::getInstance().currentGlobalScene()->omniLights.size());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Dir Lights:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%zu", GlobalData::getInstance().currentGlobalScene()->dirLights.size());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Area Lights:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%zu", GlobalData::getInstance().currentGlobalScene()->areaLights.size());
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Input Vertices:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.InputVertices);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Input Primitives:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.InputPrimitives);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("VS Invocations:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.VSInvocations);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Clipping Invocations:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.ClippingInvocations);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Clipping Primitives:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.ClippingPrimitives);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("PS Invocations:");
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.PipelineStats.PSInvocations);
                        ImGui::TableNextRow();
                        ImGui::TableSetColumnIndex(0);
                        ImGui::Text("Input Vertices:");
                        ImGui::TableSetColumnIndex(1);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::Text("%d", query.Occlusion.NumSamples);
